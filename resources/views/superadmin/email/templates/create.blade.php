{{-- 
    ...
    View: Admin — Create Email Template — Premium v2.0
--}}
@extends('layouts.app')
    ...
    <div class="col-md-9">
        ...
        <div class="form-card">
            <div class="form-card-header">
                <div class="form-card-header-icon"><i class="fas fa-envelope-open-text"></i></div>
                <div>
                    <div class="form-card-title">New Email Template</div>
                    <div class="form-card-desc">Design a new transactional HTML email with placeholdable variables.</div>
                </div>
            </div>
            <div class="form-card-body">
                <form action="{{ route('superadmin.email.templates.store') }}" method="POST">
                    ...
                    <div class="custom-form-group">
                        ...
                        <input type="text" name="name" class="custom-input" placeholder="e.g. Welcome Email" required>
                    ...
                    <div class="custom-form-group">
                        ...
                        <input type="text" name="subject" class="custom-input" placeholder="e.g. Welcome to BuyNiger, {name}!" required>
                    ...
                    <div class="custom-form-group">
                        ...
                        <input type="text" name="variables" class="custom-input" placeholder="e.g. {name}, {order_id}, {cta_url}">
                    ...
                    <div class="custom-form-group">
                        ...
                        <textarea name="body" class="custom-textarea" rows="15" placeholder="<html>
  <body style='font-family: Arial, sans-serif;'>
    <h2>Hello {name},</h2>
    <p>Thank you for signing up to BuyNiger!</p>
  </body>
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="btn-submit-template">
                            <i class="fas fa-paper-plane"></i> Create Template
                        </button>
                    </div>
                </form>
            </div>
